...
Q_DECLARE_OPERATORS_FOR_FLAGS( Highcontrast::AnimationModes )
Q_DECLARE_OPERATORS_FOR_FLAGS( Highcontrast::Corners )
Q_DECLARE_OPERATORS_FOR_FLAGS( Highcontrast::Sides )

...
#include "highcontraststyle.h"

#include "highcontrast.h"
#include "highcontrastanimations.h"
#include "highcontrasthelper.h"
#include "highcontrastmnemonics.h"
#include "highcontrastpropertynames.h"
#include "highcontrastsplitterproxy.h"
#include "fakehighcontraststyleconfigdata.h"
#include "highcontrastwidgetexplorer.h"
#include "highcontrastwindowmanager.h"
...
namespace HighcontrastPrivate
{
    ...
    class TabBarData: public QObject
    {
        ...
        Highcontrast::WeakPointer<const QWidget> _tabBar;
    ...
    class ComboBoxItemDelegate: public QItemDelegate
    {
        ...
        ComboBoxItemDelegate( QAbstractItemView* parent ):
            ...
            _itemMargin( Highcontrast::Metrics::ItemView_ItemMarginWidth )
        {}
        ...
        //* proxy
        Highcontrast::WeakPointer<QAbstractItemDelegate> _proxy;
...
namespace Highcontrast
{
    ...
    Style::Style( void ):
        ...
        #if ADWAITA_USE_KDE4
        , _helper( new Helper( "highcontrast" ) )
        #else
        , _helper( new Helper( ) )
        #endif
        ...
        , _tabBarData( new HighcontrastPrivate::TabBarData( this ) )
        #if ADWAITA_USE_KDE4
        ...
        #endif
    {
        ...
        // use DBus connection to update on highcontrast configuration change
        QDBusConnection dbus = QDBusConnection::sessionBus();
        dbus.connect( QString(),
            QStringLiteral( "/HighcontrastStyle" ),
            QStringLiteral( "org.kde.Highcontrast.Style" ),
            QStringLiteral( "reparseConfiguration" ), this, SLOT(configurationChanged()) );

        dbus.connect( QString(),
            QStringLiteral( "/HighcontrastDecoration" ),
            QStringLiteral( "org.kde.Highcontrast.Style" ),
            QStringLiteral( "reparseConfiguration" ), this, SLOT(configurationChanged()) );
    ...
    void Style::polish( QWidget* widget )
    {
        ...
        if( qobject_cast<QScrollBar*>( widget ) )
        {
            ...
            if( !hasParent( widget, "QWebView" ) )
            {
                ...
                { itemView->setItemDelegate( new HighcontrastPrivate::ComboBoxItemDelegate( itemView ) ); }
            }
    ...
    {
        return Highcontrast::Settings::ShowIconsInMenuItems;
    }

    //____________________________________________________________________
    bool Style::showIconsOnPushButtons( void ) const
    {
        return Highcontrast::Settings::ShowIconsOnPushButtons;
    }
